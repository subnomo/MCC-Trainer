...
fn invincibility(game: &Game) {
    ...
    code_cave.append(&mut vec![
        0x48, 0x8B, 0x80, 0xD8, 0x0, 0x0, 0x0,  // mov rax, [rax+D8]
        0x48, 0x8B, 0x80, 0xB8, 0x5, 0x0, 0x0,  // mov rax, [rax+5B8]
        ...
        0xE9, 0x3F, 0x60, 0x4A, 0xFF,           // jmp haloreach.dll+1BE21C ; jump back to hook
    ]);
